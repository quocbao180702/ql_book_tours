			...
			<div class="card mt-3">
				...
				<div class="card-body">
					...
					<form action="nguoidung_sua_xuly.php" method="post" class="needs-validation" novalidate>
						<input type="text" id="ID" name="ID" value="<?php echo $result['MaNguoiDung']; ?>" hidden />
						
						<div class="mb-3">
							<label for="HoVaTen" class="form-label">Họ và tên</label>
							<input type="text" class="form-control" id="HoVaTen" name="HoVaTen" value="<?php echo $result['TenNguoiDung']; ?>" required />
