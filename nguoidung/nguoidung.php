							...
							<?php
								...
								foreach($result as $value)
								{
									echo '<tr>
											...
											<td class="text-center"><a href="nguoidung_sua.php?id=' . $value['MaNguoiDung'] . '"><i class="bi bi-pencil-square"></i></a></td>
											<td class="text-center"><a href="nguoidung_xoa.php?id=' . $value['MaNguoiDung'] . '" onclick="return confirm(\'Bạn muốn xóa người dùng ' . $value['TenNguoiDung'] . ' không?\')"><i class="bi bi-trash text-danger"></i></a></td>
										  </tr>';
								}
							?>
						</tbody>
